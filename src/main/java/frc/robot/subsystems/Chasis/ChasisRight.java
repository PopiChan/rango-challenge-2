...
public class ChasisRight implements MotorSubsystem {
  ...
  public static ChasisRight chasisright;
  ...
  public static ChasisRight getinstance(){
    if (chasisright == null){
      chasisright = new ChasisRight();
    }
    return chasisright;
  }
}
